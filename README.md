...
Register at **https://go.elfa.ai/claude-skills** and start on **pay-as-you-go** — $0.0145 per credit, $20 minimum top-up, card or USDC. The free tier is being phased out, so new integrations should start on PAYG.
...
Trending narratives and AI chat require Grow+ or PAYG; streaming AI chat requires PAYG or Enterprise; market events are Enterprise only — see the link above for details.
...
```
Notify me when 3+ of the funds I track all start following the same X account
```
